                    ...
                    <div class="d-flex gap-2">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                ...
                                <button id='AddSystemConfig' class="btn btn-info mb-2 float-end" data-bs-toggle="modal"
                                    ...
                                    <table class="table basic-datatable" id="AvailableAccounts">
                                        <thead>
                                            <tr class="text-center text-white">
                                                ...
                                                <th class="py-2 px-0">Company ID</th>
                                        ...
                                        <tbdy style="overflow:auto ;">
                                            @php
                                                $configs = App\Models\SystemConfiguration::paginate(15);
                                            @endphp
            ...
            <div class="modal-content" style="font-family: Calibri">
                ...
                <div class="modal-body">
                    <form class="ps-3 pe-3" method="POST" action="{{ route('addConfig') }}" id="sysConfigForm">
                        ...
                        <div class="mb-3">
                            <label for="CompanySelect" class="form-label">Company Account</label>
                            <div style="width: 415px;">
                            <select class="form-select" id="addOptionCompany" name="Company_Id" id="example-select">
                            <option id="firstoption" selected disabled></option>
                             </select>
                                <!-- <select class="form-control select2" id="AddCompanyAccount" data-toggle="select2">
                                    <option id="firstoption" disabled selected></option>
                                        <option value=""> putanigna</option>
                ...
                <div class="modal-body">
                    ...
                    <form class="ps-3 pe-3" autocomplete="on" id="config-update" action="{{ route('update-config') }}"
                        ...
                        <!-- <div class="mb-3">
                            ...
                            <select class="form-select" id="UpdateCompanyAccount" id="example-select">   
