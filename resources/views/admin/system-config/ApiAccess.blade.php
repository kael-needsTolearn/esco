            ...
            <form method="POST" action="{{ route('AddApiAccess') }}" id="Form1">
                <div class="card">
                    <div class="card-body" style="height: 300px;">
                        <h3 style="white-space: nowrap;" class="header-title text-secondary float-left text-left p-0 ">
                        Available API's
                        </h3>
                        <!-- <label class="text-secondary mt-1">Select to Assign API</label> -->
                        <div class="table-responsive" style="height: 200px !important; overflow-y:auto;">
                            <table class="table basic-datatable"
                                id="AvailableAccounts">
                                <thead class="text-center text-white">
                                    <tr>
                                    <th style='padding:0.55rem 0.55rem;width:50px;'>CHECKBOX</th>
                                    <th style='padding:0.55rem 0.55rem;width:100px;'>PLATFORM</th>
                                    <th style='padding:0.55rem 0.55rem'>DESCRIPTION</th>
                                    </tr>
                                </thead>
                                <tbody id="tbbody1">
            ...
            <form method="POST" action="{{ route('AddApiAccess') }}" id="Form2">
                ...
                <div class="card-body" style="height: 300px;">
                        <h3 style="white-space: nowrap;" class="header-title text-secondary text-left p-0">Current Assigned
                            API's</h3>
                        <!-- <label class="text-secondary mt-1">Select to Unassign API</label> -->
                    <div class="table-responsive" style="height: 200px !important; overflow-y:auto;">
                        <table class="table basic-datatable" id="CurrentAccounts">
                        <thead class="text-center text-white">
                                <tr >
                                    <th style='padding:0.55rem 0.55rem;width:50px;'>CHECKBOX</th>
                                    <th style='padding:0.55rem 0.55rem;width:100px;'>PLATFORM</th>
...
@endsection
@section('javascripts')
    <script src="Modules/assets/js/esco/Api-Access.js?1716965995812"></script>
@endsection
