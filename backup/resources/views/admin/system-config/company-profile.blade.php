                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="row mb-3">
                                                                            ...
                                                                            <input autocomplete="off" hidden type="text" autofocus class="form-control" id="Company_Id" name="Company_Id">
                                                                                <input autocomplete="off" type="text" autofocus  class="form-control text-capitalize" id="Company_Name" name="Company_Name">
                                                                            </div>
                                                                        </div>
                                                                        <div class="row mb-3">
                                                                         <div class="col-12 d-flex">
                                                                            ...
                                                                            <input autocomplete="off" type="text" id="Company_Address"  name="Company_Address" class="form-control text-capitalize">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-12 d-flex">
                                                                            <label class="col-md-3 col-form-label" for="Country">
                                                                                ...
                                                                                <input autocomplete="off" type="text" id="Country"
                                                                                    name="Country" class="form-control text-capitalize">
                                                                            </div>
                                                                        </div>
                                                                    </div> <!-- end col -->
                                                                </div> <!-- end row -->
                                                                    ...
                                                                    <div class="col-12">
                                                                        ...
                                                                        <div class="col-12 d-flex">
                                                                            <label class="col-md-4 col-form-label text-nowrap  " for="Account_Manager">
                                                                                ...
                                                                                <input autocomplete="off" type="text" id="Account_Manager" name="Account_Manager" class="form-control text-capitalize">
                                                                            </div>
                                                                        </div>
                                                                        <div class="row mb-3">
                                                                        <div class="col-12 d-flex">
